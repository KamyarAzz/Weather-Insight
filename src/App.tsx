...
function App() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 py-16 w-full h-full text-black overflow-y-auto">
        ...
        weatherData && (
          <>
            ...
            <main>
              ...
              <div className="flex items-center gap-4 sm:grid sm:grid-cols-4 mt-14 overflow-x-scroll">
